# HHS Federal Contract Spending Analysis — FY2024

## Overview
Analysis of U.S. Department of Health and Human Services (HHS) federal contract spending data sourced from USASpending.gov. This project uses SQL for data analysis and Power BI for visualization.

## Tools Used
- SQLite / DB Browser for SQLite
- Power BI Desktop
- USASpending.gov (public dataset)
...
- `federal_spending_dashboard.pbix` — Power BI dashboard file
